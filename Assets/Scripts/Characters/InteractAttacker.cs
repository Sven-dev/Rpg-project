...
public class InteractAttacker : MonoBehaviour {
	...
	void Start ()
    {
        ...
        Colliders.AddRange(transform.GetChild(0).GetChild(1).GetComponentsInChildren<BoxCollider>());
    }
    ...
    public void SetInteractTrigger()
    {
        ...
        {
            case Direction.Up:
                rotator.localEulerAngles = new Vector3(0, 0, 90);
                break;
            case Direction.Down:
                rotator.localEulerAngles = new Vector3(0, 0, -90);
                break;
            case Direction.Left:
                rotator.localEulerAngles = new Vector3(0, 0, 180);
                break;
            case Direction.Right:
                rotator.localEulerAngles = new Vector3(0, 0, 0);
                break;
            case Direction.UpLeft:
                rotator.localEulerAngles = new Vector3(0, 0, 135);
                break;
            case Direction.UpRight:
                rotator.localEulerAngles = new Vector3(0, 0, 45);
                break;
